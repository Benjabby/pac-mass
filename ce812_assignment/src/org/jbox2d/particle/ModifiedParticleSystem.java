...
/**
 * A modified version of the ParticleSystem class to allow for collision filtering.
 * @author Original ParticleSystem class by  Daniel Murphy
 */
public class ModifiedParticleSystem extends ParticleSystem
{
	public static final int IGNORE_PARTICLE_CATEGORY = 1<<15;
  ...
  public ModifiedParticleSystem(World world) 
  {
   super(world);
  }
...
//    assert(d2 != 0);
  ...
  static class UpdateBodyContactsCallback implements QueryCallback {
    ModifiedParticleSystem system;

    private final Vec2 tempVec = new Vec2();

    @Override
    public boolean reportFixture(Fixture fixture) {
      if (fixture.isSensor() || (fixture.m_filter.categoryBits & IGNORE_PARTICLE_CATEGORY)!=0) {
        return true;
      }
